                                            ...
                                            <table   border="0" cellspacing="0" cellpadding="0"  id="dynamictable">
                                                <tr>
                                                    <div class="form-group-md" align="right">
                                                        ...
                                                        <?php
                                                        $max = $db->maxOfAll("CONVERT(REPLACE(transactionid,'SA',''),UNSIGNED INTEGER)","stock_sales");
                                                ...
                                                <tr>
                                                    <div class="form-group-md" align="center">
                                                        ...
                                                        <td><input readonly class="form-control" type="text" name="billnumber" style="width:100px;" id="billnumber"  class="validate[required,length[0,100]] text-input" required value="<?php echo date("Y").$max; ?>"></td></td>
                                                        <td>&nbsp;</td>
