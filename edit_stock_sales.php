                                ...
                                <div class="row">
                                    ...
                                    if(isset($_POST['billnumber']))
                                    {
                                        ...
                                        $oldvalue = $db->queryUniqueValue("SELECT balance FROM customer_details WHERE customer_name='$customer' 
																			/*AND customer_address='$address' AND customer_contact1='$contact1' AND customer_contact2='$contact2'*/");
                                       ...
                                       // echo "<div style='background-color:yellow;'><br><font color=green size=+1 >Sales Updated ! Transaction ID [ $autoid ]</font></div> ";
                                        ...
                                        $count1 = $db->queryUniqueValue("SELECT count(*) FROM customer_details WHERE customer_name='$customer' 
																			/*AND customer_address='$address' 
																			AND customer_contact1='$contact1' 
																			AND customer_contact2='$contact2'*/");
                                        if($count1!=1)
                                        {
                                            $db->query("insert into customer_details(customer_name,customer_address,customer_contact1,customer_contact2) 
														values('$customer','$address','$contact1','$contact2')");
                                            //echo "<br><font color=green size=+1 > [ $name ] Customer Details Updated !</font>" ;
                                        }else {
											$db->execute("UPDATE customer_details SET customer_address='$address',customer_contact1='$contact1',customer_contact2='$contact2' WHERE customer_name='$customer'");
										}
                                            ...
                                            <table   border="0" cellspacing="0" cellpadding="0"  id="dynamictable">
                                                ...
                                                <tr>
                                                    <div class="form-group-md" align="center">
                                                        ...
                                                        <td><input readonly class="form-control" type="text" name="billnumber" style="width:100px;" id="billnumber" value="<?php echo $line->billnumber; ?>"  class="validate[required,length[0,100]] text-input" required></td></td>
                                                        <td>&nbsp;</td>
